#pragma checksum "C:\Users\amine\source\repos\Force tracking\ForceT\Client\Pages\EntréeStock\CreationJrStock.razor" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "76f4298180b013b7292fd573f007b24ed95a20f0"
// <auto-generated/>
...
#line hidden
#nullable disable
    [Microsoft.AspNetCore.Components.RouteAttribute("/creationjrstock")]
    public partial class CreationJrStock : Microsoft.AspNetCore.Components.ComponentBase
    {
...
#nullable restore
#line 48 "C:\Users\amine\source\repos\Force tracking\ForceT\Client\Pages\EntréeStock\CreationJrStock.razor"
       

    JournalStock JrStock = new JournalStock();
    private bool wait = false;
    bool show = false;

    private async Task CreerJrStock()
    {
        wait = true;
        string JrStockContent = JsonConvert.SerializeObject(JrStock);
        var response = await Http.PostAsync("api/JournalStocks", new StringContent(JrStockContent, Encoding.UTF8, "application/json"));

        if (response.IsSuccessStatusCode)
        {
            NavigationManager.NavigateTo("/JournalStocks");
            wait = false;
        }
        else
        {
